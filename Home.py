...
with col1:
    ...
    y_min_value = st.number_input("Value min", key="y_min_value", step = 1)
    y_max_value = st.number_input("Value max", key="y_max_value", step = 1)
...
with col2:
    ...
    x_min_value = st.number_input("Value min", key="x_min_value", step = 1)
    x_max_value = st.number_input("Value max", key="x_max_value", step = 1)
